...
interface SustainabilityProps {
  ...
  generationMix: Record<string, { output: number; emissions: number }>;
}
...
export default function Sustainability({
  ...
  currentRenewableGeneration = 0,
  currentEmissionsRate = 0,
  gridIntensity = 0,
  generationMix = {},
}: SustainabilityProps) {
  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-gray-50 rounded-lg p-6">
          ...
          <div className="text-3xl font-bold text-purple-900">
            {currentEmissionsRate?.toFixed(1) || "0.0"}
      ...
      <div className="mt-6">
        ...
        {Object.entries(generationMix).map(([type, data]) => (
          <div
            key={type}
          ...
          >
            <div>
              ...
              <div className="text-sm text-gray-600">
                {data.output?.toFixed(1) || "0.0"} MW (
                {((data.output / (currentTotalGeneration || 1)) * 100)?.toFixed(
                  1
                ) || "0.0"}
                %)
              </div>
            ...
            <div className="text-right">
              <div className="text-lg font-medium">
                {data.emissions?.toFixed(1) || "0.0"} kg CO<sub>2</sub>/h
              </div>
              <div className="text-sm text-gray-600">
